...
## 小附录
0. 两个作者对文章贡献相同。
1. 图2(C)部分使用最小二乘法进行拟合。
2. 学历部分：学历以将要获得的最高学历为参考，例如本科毕业，硕士在读——硕士，硕士毕业，博士在读——博士。
3. 数据收集与：2020年6月20日，选取缘分天空第5至20页数据（这部分数据相对稳定）。
4. 吐槽：数据噪声太大，没法做，做到0.6相关性的时候我都想放弃了，但是想一想也勉强合理，毕竟怎么可能不看脸呢？做出0.9相关性岂不是造假了。
